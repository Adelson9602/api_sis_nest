...
export class HumanManagementController {
  constructor(private readonly humanManagementService: HumanManagementService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateHumanManagementDto: UpdateHumanManagementDto) {
